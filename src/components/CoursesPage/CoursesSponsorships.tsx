...
import type { CoursesSponsorshipsProps } from "@/types";
		...
		>
			<ViewContainer className="flex flex-col items-center">
				...
				<p className="w-full md:max-w-[80%] lg:max-w-[70%] text-gray-500 text-lg md:text-[20px] mt-3 md:mt-4 lg:mt-5 text-center">
					Unlock the full potential of your product with tailored
					courses designed to empower developers and users alike. By
					partnering with me, you gain access to a dynamic platform
					where your product can be showcased, explored, and mastered
					by a vast audience of eager learners. Together, we can
					create impactful educational experiences that drive
					engagement, foster innovation, and solidify your
