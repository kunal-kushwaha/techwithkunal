...
export const COURSES: CoursesInfo = [
	{
		title: "Introduction to Cloud Monitoring, Performance, and Incident Management",
		hasPage: true,
		description:
		...
		about: "In this course, you'll dive into the essentials of DevOps, exploring server monitoring with tools like Site24x7, optimizing application performance, mastering incident management protocols, and gaining insights into FinOps principles for efficient cloud cost management.",
		...
		syllabus: [
			{
				...
				points: "This course covers strategies and tools for effective cloud infrastructure monitoring, ensuring visibility into performance, security, and resource utilization.",
			},
			{
				title: "Server Sentinel: Comprehensive Server Monitoring Guide",

				points: "Exploring server monitoring techniques, including hardware health checks, resource usage tracking, and proactive troubleshooting methods.",
			},
			{
				title: "Optimize & Excel: Application Performance Monitoring Demystified",

				points: "Delving into monitoring application performance, from identifying bottlenecks to optimizing code and infrastructure for enhanced user experience.",
			},
			{
				title: "Crisis Averted: Incident Management Essentials",

				points: "Focuses on developing skills and protocols for efficiently managing and mitigating incidents, including communication strategies, incident response planning, and post-mortem analysis.",
			},
			{
				title: "Financial Fitness: Navigating FinOps for Cloud Cost Management",

				points: "Offers insights into FinOps practices for cloud environments, including cost optimization strategies, budgeting techniques, and leveraging cloud provider pricing models.",
			},
		],
	},
	{
	...
	},
	{
		...
		slug: "dsa",
		about: "Get interview-ready with this course that has no prerequisites and is designed to make you an expert in solving easy to hard LeetCode problems with ease. Master the thought process behind solving problems, and clear interviews of top tier companies.",
		image: courseDsa,
		introVideoEmbedLink:
		...
		syllabus: [
			...
			},
			{
				...
				points: "How Java works, setup installation, input and output, conditionals and loops, data types, and coding best practices.",
			},
			{
				title: "Functions / Methods",
				points: "Introduction to functions, scoping, shadowing, functional arguments, function overloading.",
			},
			{
				title: "Arrays and ArrayList",
				points: "How arrays work in Java, memory management, input and output, ArrayList introduction.",
			},
			{
				title: "Searching",
			...
			{
				title: "Sorting",
				points: "Insertion, selection, bubble, cyclic, merge, quick, count, radix, and heap sort.",
			},
			{
				title: "Time and space complexity",
				points: "Introduction, various cases, linear recurrence, divide-n-conquer recurrence, notations, solving recurrences, space complexity, NP-completeness.",
			},
			{
				title: "Mathematics",
				points: "Bitwise operators, range of data types, prime numbers, factors, modulo properties, number theory.",
			},
			{
				title: "Recursion",
				points: "Introduction, how to master recursion, flow of program, tree building, tail recursion, sorting, string, array, pattern, subset questions.",
			},
			{
				title: "Backtracking",
				points: "Introduction, Maze problems, N-queens, N-knights, sudoku solver.",
			},
			{
				title: "Object-Oriented Programming",
				points: "Introduction, classes, objects, this keyword, properties, overloading, overriding, static, packages, access control, interfaces, abstract classes, annotations, singleton class, keywords, object class, generics, exception handling, vector class, collections framework, lambda expressions, enums.",
			},
			{
				title: "Linked List",
				points: "Introduction, singly, doubly, circular, fast and slow pointer, cycle detection, reversal of Linked List, Linked List with recursion.",
			},
			{
				title: "Stacks and Queues",
				points: "Introduction, push efficient, pop efficient, queue using stack and vice versa, circular queue.",
			},
			{
				title: "Trees",
				points: "Introduction to binary trees, binary search trees, DFS, BFS, AVL trees, segment trees.",
			},
			{
				title: "Hashmaps",
				points: "Introduction, theory, comparisons, limitations, map using Linked List, map using Hash, sorting, chaining, probing, Huffman-encoder.",
			},
			{
				title: "Dynamic programming",
				points: "Introduction, recursion, recursion + dp, iteration, iteration + space optimized, complexity analysis, 0/1 Knapsack, subset questions, unbounded knapsack, subsequence questions, string dp.",
			},
			{
				title: "Heaps",
				points: "Introduction, theory, priority queue, heapsort, two heaps method, k-way merge, top-k elements, interval problems.",
			},
			{
				title: "Graph theory",
				points: "Introduction, BFS, DFS, components, minimum spanning trees, Kruskal, Prims, Dijkstra's shortest path, topological sort, Bellman ford, A* pathfinding.",
			},
			{
				title: "Additional topics",
				points: "Greedy algorithms, tries, sliding window, two pointer, Kadane's algorithm, and more!",
			},
		],
	},
	{
		...
		slug: "devops",
		about: "In this course, you will gain hands-on experience with a wide range of DevOps tools, from basic to advanced, ensuring you're well-equipped for the industry. Engage in practical projects that solidify your learning and prepare you for real-world applications.",
		image: courseDevops,
		introVideoEmbedLink:
		...
		syllabus: [
			{
				...
				points: "Networking fundamentals, OSI layer protocols, port forwarding, how the internet works, command line tools, and more.",
			},
			{
				title: "Command line tools",
				points: "Various command line tools, bash scripting, regex, introduction to git, and more.",
			},
			{
				title: "Kubernetes",
				points: "Introduction, architecture, set-up, objects, networking, storage, HA, monitoring, logging, production-ready applications.",
			},
			{
				title: "Servers",
			...
			},
			{
				...
				points: "Infrastructure provisioning, Terraform, Pulumi, configuration management, and more.",
			},
			{
				title: "Service mesh",
			...
			},
			{
				...
				points: "Learn about the essentials of working with Linux, including some important commands.",
			},
			{
				title: "Docker",
				points: "Introduction to containers, hands-on demos, concepts, architecture, images, networking, best practices, development profiles, Docker Compose, Docker Swarm.",
			},
			{
				title: "GoLang",
			...
			{
				title: "CI/CD",
				points: "Setting up a CI/CD pipeline, GitHub Actions, Circle CI, and more.",
			},
			{
				title: "Monitoring and logging",
				points: "Monitoring tools and practices, Prometheus, Thanos, Grafana, Jaeger, New Relic, and more.",
			},
			{
				title: "GitOps",
				points: "Manage infrastructure and application configurations using Git.",
			},
			{
				title: "Testing",
			...
			},
			{
				...
				points: "Navigating the Cloud Native tools landscape with a hands-on deep dive to get you started with the use-cases and contributor journey of various projects",
			},
		],
	},
	{
